const Monitizebutton = () => {
    return (
        <div className="bg-blue-600 ml-5 flex justify-center h-16 items-center rounded-2xl w-[80%]">
            <button className="flex pl-7 h-6 justify-center items-center bg-white rounded-2xl">
                <div className="">
